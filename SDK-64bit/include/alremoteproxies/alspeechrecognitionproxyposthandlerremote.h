...
#ifndef ALSPEECHRECOGNITIONPROXYPOSTHANDLERREMOTE_H_
#define ALSPEECHRECOGNITIONPROXYPOSTHANDLERREMOTE_H_
#include <alremotecall/alremoteproxy.h>

namespace AL
{
class ALSpeechRecognitionProxyRemote;
...
class ALSpeechRecognitionProxyPostHandlerRemote : public ALProxyRemote
{
    friend class ALSpeechRecognitionProxyRemote;
  ...
  public:
    ...
    /// ALSpeechRecognitionPostHandlerRemote gives acces to all bound methods of the module, using a thread around each call.
    /// Long running tasks can be stopped by calling stop(id) with the id returned by the post.
    /// </summary>
    ALSpeechRecognitionProxyPostHandlerRemote() : fParent(NULL)
    {}
    ...
    {
      return fParent->pCall("loadVocabulary" , vocabularyFile);
    }
    ...
    {
      return fParent->pCall("setAudioExpression" , setOrNot);
    }
    ...
    {
      return fParent->pCall("setLanguage" , languageName);
    }
    ...
    {
      return fParent->pCall("setParameter" , paramName, paramValue);
    }
    ...
    {
      return fParent->pCall("setVisualExpression" , setOrNot);
    }
    ...
    {
      return fParent->pCall("setVocabulary" , vocabulary, enabledWordSpotting);
    }
    ...
    {
      return fParent->pCall("setWordListAsVocabulary" , vocabulary);
    }
...
#endif // ALSPEECHRECOGNITIONPROXYPOSTHANDLERREMOTE_H_
