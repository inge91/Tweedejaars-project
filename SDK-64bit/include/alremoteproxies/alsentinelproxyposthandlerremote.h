...
class ALSentinelProxyPostHandlerRemote : public ALProxyRemote
{
  ...
  public:
    ...
    {
      return fParent->pCall("batteryChargeCellVoltageMinChanged" , dataName, data, message);
    }
    ...
    {
      return fParent->pCall("onAccX" , dataName, data, message);
    }
    ...
    {
      return fParent->pCall("onAccY" , dataName, data, message);
    }
    ...
    {
      return fParent->pCall("onAccZ" , dataName, data, message);
    }
    ...
    {
      return fParent->pCall("powerButtonOnPress" , dataName, data, message);
    }
