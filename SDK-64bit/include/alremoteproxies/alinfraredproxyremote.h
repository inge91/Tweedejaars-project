...
class ALInfraredProxyRemote : public ALProxyRemote
{
  public:
    ...
    std::string confRemoteRecordAddKey(const std::string& Keyname)
    {
        ...
        return callRemote<std::string >("confRemoteRecordAddKey" , Keyname);
    }
    ...
    std::string confRemoteRecordCancel()
    {
        ...
        return callRemote<std::string >("confRemoteRecordCancel");
    }
    ...
    std::string confRemoteRecordGetStatus()
    {
        ...
        return callRemote<std::string >("confRemoteRecordGetStatus");
    }
    ...
    std::string confRemoteRecordNext()
    {
        ...
        return callRemote<std::string >("confRemoteRecordNext");
    }
    ...
    void confRemoteRecordStart(const std::string& Rm_name)
    {
        ...
        callVoidRemote("confRemoteRecordStart" , Rm_name);
    }
