...
class SolutionAnalysis
{
  ...
  public:
    ...
    returnValue getMaxKKTviolation(  QProblemB* qp,      /**< QProblemB to be analysed. */
                    Real& maxKKTviolation  /**< OUTPUT: maximum violation of the KKT conditions. */
                    ) const;
    ...
    returnValue getVarianceCovariance(  QProblemB* qp,      /**< QProblemB to be analysed. */
                      Real* g_b_bA_VAR,    /**< INPUT : Variance-covariance of g, the bounds lb and ub, and lbA and ubA respectively. Dimension: 2nV x 2nV */
                      Real* Primal_Dual_VAR  /**< OUTPUT: The result for the variance-covariance of the primal and dual variables. Dimension: 2nV x 2nV */
                      ) const;
    ...
    returnValue getVarianceCovariance(  QProblem* qp,      /**< QProblem to be analysed. */
                      Real* g_b_bA_VAR,    /**< INPUT : Variance-covariance of g, the bounds lb and ub, and lbA and ubA respectively. Dimension:  (2nV+nC) x (2nV+nC) */
                      Real* Primal_Dual_VAR  /**< OUTPUT: The result for the variance-covariance of the primal and dual variables. Dimension:  (2nV+nC) x (2nV+nC) */
                      ) const;
