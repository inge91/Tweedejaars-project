...
returnValue print(  const Real* const v,  /**< Vector to be printed. */
...
/** Prints a matrix.
 * \return SUCCESSFUL_RETURN */
returnValue print(  const Real* const M,  /**< Matrix to be printed. */
...
/** Reads a Real matrix from file.
 * \return SUCCESSFUL_RETURN \n
        RET_UNABLE_TO_OPEN_FILE \n
       RET_UNABLE_TO_READ_FILE */
returnValue readFromFile(  Real* data,        /**< Matrix to be read from file. */
              int nrow,          /**< Row number of matrix. */
              int ncol,          /**< Column number of matrix. */
              const char* datafilename  /**< Data file name. */
              );

/** Reads a Real vector from file.
 * \return SUCCESSFUL_RETURN \n
        RET_UNABLE_TO_OPEN_FILE \n
       RET_UNABLE_TO_READ_FILE */
returnValue readFromFile(  Real* data,        /**< Vector to be read from file. */
              int n,            /**< Length of vector. */
              const char* datafilename  /**< Data file name. */
              );
 ...
 * \return SUCCESSFUL_RETURN \n
        RET_UNABLE_TO_OPEN_FILE  */
returnValue writeIntoFile(  const Real* const data,  /**< Matrix to be written into file. */
              int nrow,          /**< Row number of matrix. */
              int ncol,          /**< Column number of matrix. */
              const char* datafilename,  /**< Data file name. */
 ...
 * \return SUCCESSFUL_RETURN \n
        RET_UNABLE_TO_OPEN_FILE  */
returnValue writeIntoFile(  const Real* const data,  /**< Vector to be written into file. */
              int n,            /**< Length of vector. */
              const char* datafilename,  /**< Data file name. */
              BooleanType append      /**< Indicates if data shall be appended if the file already exists (otherwise it is overwritten). */
              );
 ...
 * \return 0: successful */
 Real getNorm(  const Real* const v,  /**< Vector. */
...
inline Real getSign(  Real arg  /**< Real-valued argument whose sign is to be determined. */
            );
