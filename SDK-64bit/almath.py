...
class Pose2D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.Pose2D___str__(self)
...
class Position2D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.Position2D___str__(self)
...
class Position3D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.Position3D___str__(self)
...
class Position6D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.Position6D___str__(self)
...
class PositionAndVelocity(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.PositionAndVelocity___str__(self)
...
class Rotation3D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.Rotation3D___str__(self)
...
class Velocity3D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.Velocity3D___str__(self)
...
class Velocity6D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.Velocity6D___str__(self)
...
class TransformAndVelocity6D(_object):
    ...
    def __str__(self):
        """__str__(self) -> char"""
        return _almath.TransformAndVelocity6D___str__(self)
