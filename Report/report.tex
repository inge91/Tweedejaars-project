...
different potential solutions to this problem, for example: 
\begin{enumerate}
...
We have tried different techniques (see appendix A), but in the end used \dots 
