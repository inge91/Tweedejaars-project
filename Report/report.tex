...
experiments have been conducted on Nao version 3.3
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.4]{pics/hardware_inertialunit.png}
	\label{fig:hardware}
	\caption{The force-sensitive resistors under Nao's feet}
\end{figure}
...
Although balancing using the Center Of Mass allows a good conversion to a
...
impossbile to get this value as the most optimal point. When lowering the
...
This gives the presumption that the calculations used work quite well with this
value for $\delta$ but more experimentations are needed to be certain.
