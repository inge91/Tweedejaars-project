...
%position is not one we have encountered.  The same with using a
%dampened least squares solution for solving the inverse kintematics.
%
%It comes to show that although our problem initially looked as if it would be a
%straight path that would lead us 
